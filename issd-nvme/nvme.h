...
// gunjae: read commands from SQ and delete?
...
// gunjae: what is NvmeCQ and NvmeSQ?
...
/// gunjae: command queue scheduler?
...
/// gunjae: looks like control command to initialize NVME controllers?
...
#if (GK_MEASURE_TIME)
	uint64_t	nand_acc_cnt;
	clock_t		nand_acc_clks;
	double		nand_acc_time;
	//clock_t		nand_bw_init_clks;
	struct timespec nand_bw_init_time;
	uint64_t	dram_acc_cnt;
	clock_t		dram_acc_clks;
	clock_t		dram_bw_init_clks;
	//uint64_t	ls2_acc_cnt;
	//clock_t		ls2_acc_clks;
	//double		ls2_acc_time;
	////clock_t		ls2_bw_init_clks;
	//struct timespec ls2_bw_init_time;
	exec_time_t et_ls2_data;
	exec_time_t et_ls2_ctrl;
	exec_time_t	et_proc;
	//uint64_t	func_acc_cnt;
	//clock_t		func_acc_clks;
	//double		func_acc_time;
	//clock_t		func_bw_init_clks;
#endif
} NvmeCtrl;
